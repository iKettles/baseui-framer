...
import { controls, merge } from "./generated/StatefulSelect";
...
const InnerStatefulSelect: React.SFC = props => {
  return <System.StatefulSelect {...props} style={style} />;
};

export const StatefulSelect = withHOC(InnerStatefulSelect);
...
addPropertyControls(StatefulSelect, {
