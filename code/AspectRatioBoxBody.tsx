...
import { controls, merge } from "./generated/AspectRatioBoxBody";
...
const InnerAspectRatioBoxBody: React.SFC = props => {
  return <System.AspectRatioBoxBody {...props} style={style} />;
};

export const AspectRatioBoxBody = withHOC(InnerAspectRatioBoxBody);

AspectRatioBoxBody.defaultProps = {
  width: 150,
  height: 50
};

addPropertyControls(AspectRatioBoxBody, {
